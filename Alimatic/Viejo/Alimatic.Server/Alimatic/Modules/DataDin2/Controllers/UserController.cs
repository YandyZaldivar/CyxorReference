...
namespace Alimatic.DataDin2.Controllers
{
    ...
    [Controller(Route = "datadin2 user")]
    //public class UserController : Controller<User, int, UserApiModel, DataDin2DbContext>
    public class UserController : Controller<User, DataDin2DbContext>
    {
