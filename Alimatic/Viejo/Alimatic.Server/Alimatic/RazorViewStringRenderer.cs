...
namespace Cyxor.Networking
{
    ...
    public class RazorViewStringRenderer : IViewEngine
    {
        ...
        public static void ConfigureServices(IServiceCollection services, string applicationBasePath = null)
        {
            ...
            else
            {
                ...
                //applicationBasePath = Assembly.GetEntryAssembly().Location;
            ...
            services.AddTransient<RazorViewStringRenderer>();
        }

        public RazorViewStringRenderer(IRazorViewEngine viewEngine, ITempDataProvider tempDataProvider, IServiceProvider serviceProvider)
        {
        ...
        public async Task<string> RenderAsync(object viewModel, string viewName = null)
        {
            ...
            {
                Console.WriteLine("La candela es aqui");
