...
namespace Alimatic.Datadin.Produccion.Models
{
    public class EnterpriseApiModel
    {
        ...
        public static EnterpriseApiModel[] GeiaEnterprises { get; } = new EnterpriseApiModel[]
        {
        ...
        public static EnterpriseApiModel[] MinalEnterprises { get; } = new EnterpriseApiModel[]
        {
            /* 01 */ new EnterpriseApiModel { Id = 100001, DivisionId = 1, GroupId = 1, Name = "Bucanero", FullName = "Empresa Mixta Cervecería Bucanero S.A." },
            /* 02 */ new EnterpriseApiModel { Id = 100002, DivisionId = 1, GroupId = 1, Name = "Bravo", FullName = "Bravo S.A." },
            /* 03 */ new EnterpriseApiModel { Id = 100003, DivisionId = 1, GroupId = 1, Name = "Coracán", FullName = "Coracán S.A." },
            /* 04 */ new EnterpriseApiModel { Id = 100004, DivisionId = 1, GroupId = 1, Name = "Coralac", FullName = "Coralac S.A." },
            /* 05 */ new EnterpriseApiModel { Id = 100005, DivisionId = 1, GroupId = 1, Name = "Los Portales", FullName = "Los Portales S.A." },
            /* 06 */ new EnterpriseApiModel { Id = 100006, DivisionId = 1, GroupId = 1, Name = "Molinera", FullName = "Industrial Molinera de la Habana S.A." },
            /* 07 */ new EnterpriseApiModel { Id = 100007, DivisionId = 1, GroupId = 1, Name = "Stella", FullName = "Stella S.A." },
            /* 08 */ new EnterpriseApiModel { Id = 100008, DivisionId = 1, GroupId = 1, Name = "Lefersa", FullName = "Lefersa S.A." },
            /* 09 */ new EnterpriseApiModel { Id = 100009, DivisionId = 1, GroupId = 1, Name = "Nescor", FullName = "Nescor S.A." },
            /* 10 */ new EnterpriseApiModel { Id = 100010, DivisionId = 1, GroupId = 1, Name = "Papas & Company", FullName = "Papas & Company S.A." },

            /* 11 */ new EnterpriseApiModel { Id = 200001, DivisionId = 1, GroupId = 2, Name = "Las Lomas", FullName = "Las Lomas S.A." },
            /* 12 */ new EnterpriseApiModel { Id = 200002, DivisionId = 1, GroupId = 2, Name = "La Estancia", FullName = "Empresa de Alimentos y Bebidas la Estancia S.A." },
            /* 13 */ new EnterpriseApiModel { Id = 200003, DivisionId = 1, GroupId = 2, Name = "Habana Club", FullName = "Havana Club International S.A." },

            /* 14 */ new EnterpriseApiModel { Id = 300001, DivisionId = 1, GroupId = 3, Name = "Empleadora", FullName = "Empleadora S.A." },

            /* 15 */ new EnterpriseApiModel { Id = 400001, DivisionId = 1, GroupId = 4, Name = "IIIA", FullName = "Instituto de Investigaciones de la Industria Alimentaria" },
            /* 16 */ new EnterpriseApiModel { Id = 400002, DivisionId = 1, GroupId = 4, Name = "ONIE", FullName = "Oficina Nacional de Inspección Estatal" },
            /* 17 */ new EnterpriseApiModel { Id = 400003, DivisionId = 1, GroupId = 4, Name = "CIP", FullName = "Centro de Investigaciones Pesqueras" },
            /* 18 */ new EnterpriseApiModel { Id = 400004, DivisionId = 1, GroupId = 4, Name = "Gonzalez Lines", FullName = "Instituto Marítimo Pesquero Andres Gonzalez Lines" },
            /* 19 */ new EnterpriseApiModel { Id = 400005, DivisionId = 1, GroupId = 4, Name = "UPPD", FullName = "Unidad Presupuestada de Administración Interna" },
            /* 20 */ new EnterpriseApiModel { Id = 400006, DivisionId = 1, GroupId = 4, Name = "UP Organismo Central", FullName = "UP Organismo Central" },
