...
namespace Halo.Models.Migrations.V0900
{
    ...
    {
        TrastornosHipertensivos = 1,
        ComplicacionesHemorragicas = 2,
        ComplicacionesAborto = 4,
        SepsisOrigenObstetrico = 8,
        SepsisOrigenNoObstetrico = 16,
        SepsisOrigenPulmonar = 32,
        ComplicacionEnfermedadExistente = 64,
        OtraCausa = 128,
    }
