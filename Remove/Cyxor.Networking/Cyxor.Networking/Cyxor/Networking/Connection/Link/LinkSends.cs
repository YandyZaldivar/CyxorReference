...
namespace Cyxor.Networking
{
    ...
    sealed partial class Link
    {
        internal sealed class LinkSends : LinkProperty
        {
            ...
            internal int AcquireQueue() => QueueReferences.Increment();
            internal int ReleaseQueue() => QueueReferences.Decrement();

            internal bool AddDelivery(Delivery delivery) => Queue.Add(delivery);
            internal Delivery TakeDelivery() => Queue.Take();
