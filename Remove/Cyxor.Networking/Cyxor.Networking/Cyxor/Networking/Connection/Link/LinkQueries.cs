...
namespace Cyxor.Networking
{
    ...
    sealed partial class Link
    {
        internal sealed class LinkQueries : LinkProperty
        {
            ...
            ConcurrentQueue<int> InternalsQueue;
            ConcurrentQueue<int> StandardsQueue;

            ConcurrentDictionary<int, object> InternalsAnnul;
            ConcurrentDictionary<int, object> StandardsAnnul;

            ConcurrentDictionary<int, Delivery> InternalsQuery;
            ConcurrentDictionary<int, Delivery> StandardsQuery;
