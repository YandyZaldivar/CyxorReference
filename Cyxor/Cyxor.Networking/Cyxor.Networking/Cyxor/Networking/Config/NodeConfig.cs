...
//#if !NET35
        ...
        {
            DeserializeFromJson(System.IO.File.ReadAllText(File.Name));
...
//            }
        ...
        public const bool DefaultFrameRNG = default;
        bool frameRNG = DefaultFrameRNG;
        public bool FrameRNG
        {
            get => frameRNG;
            set => SetProperty(ref frameRNG, value);
        }
