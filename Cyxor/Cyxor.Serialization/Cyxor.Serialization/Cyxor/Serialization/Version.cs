...
/// <summary>
/// Effective binary object serialization class library with a focus in low-overhead network transmissions.
/// </summary>
...
#else
            Utilities.Reflection.GetCustomAssemblyAttribute<AssemblyVersionAttribute>(typeof(Version)).Version;
#endif
    }
}
/* { Cyxor } - .NET Core Backend Framework <http://www.cyxor.com/> */
